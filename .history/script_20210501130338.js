                ...
                <div class="panel-panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9">
                                    <span class="label label-default bg-dark text-light p-1 px-2 m-3">Public Repos: ${user.public_repos}</span>
                                    <span class="label label-default bg-danger text-light p-1 px-2 m-3">Public Gists: ${user.public_gists}</span>
                                    <span class="label label-success bg-success text-light p-1 px-2 m-3">Followers: ${user.followers}</span>
                                    <span class="label label-info bg-primary text-light p-1 px-2 m-3">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
