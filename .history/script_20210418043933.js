                ...
                <div className="panel-panel-default">
                    ...
                    <div className="panel-body">
                        ...
                        <div className="col-md-9">
                            <span className="label label-default">Public Repos: ${user.public_re}</span>
                            <span className="label label-primary">Public Gists: </span>
                            <span className="label label-success">Followers: </span>
                            <span className="label label-info">Following: </span>
                        </div>
                    </div>
                </div>
            `)
