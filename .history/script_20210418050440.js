                        ...
                        <div className="well">
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <span className="label label-default">Public Repos: ${repo.fork_count}</span>
                                    <span className="label label-primary">Public Gists: ${repo.watchers_count}</span>
                                    <span className="label label-success">Followers: ${repo.stargazers_count}</span>
                                </div>
