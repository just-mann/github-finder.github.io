                    ...
                    $('#repo').append(`
                        <div class="well">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <span class="list-group-item label label-default">Forks: ${repo.fork_count}</span>
                                    <span class="list-group-item label label-primary">Watchers: ${repo.watchers_count}</span>
                                    <span class="list-group-item label label-success">Stars: ${repo.stargazers_count}</span>
                                </div>
                                <div class="col-md-2">
                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="list-group-item label label-info">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
