                ...
                <div class="panel-panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9">
                                    <span class="label label-default bg-dark text p-1">Public Repos: ${user.public_repos}</span>
                                    ...
                                    <span class="label label-info bg-success text-light p-1">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
