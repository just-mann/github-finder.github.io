                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    <span class="col-sm-9 col-sm-9 label label-default bg-dark text-light p-1 px-2 my-1">Public Repos: ${user.public_repos}</span>
                                    <span class="col-sm-9 label label-default bg-danger text-light p-1 px-2 my-1">Public Gists: ${user.public_gists}</span>
