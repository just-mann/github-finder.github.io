                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="badge badge-pill badge-primary bg-primary bg-light p-2">Public Gists: ${user.public_gists}</span>
                                    <span class="label label-success bg-secondary">Followers: ${user.followers}</span>
                                    <span class="label label-info bg-secondary">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
