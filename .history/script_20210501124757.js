                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    <span class="col-sm-12 col-xs-12 col-md-12 col-lg-3 label label-default bg-dark text-light p-1 px-2 m">Public Repos: ${user.public_repos}</span>
                                    <span class="col-sm-12 col-xs-12 col-md-12 col-lg-3 label label-default bg-danger text-light p-1 px-2 m">Public Gists: ${user.public_gists}</span>
                                    <span class="col-sm-12 col-xs-12 col-md-12 col-lg-3 label label-success bg-success text-light p-1 px-2 m">Followers: ${user.followers}</span>
                                    <span class="col-sm-12 col-xs-12 col-md-12 col-lg-3 label label-info bg-info text-light p-1 px-2 m col">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
