                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="label label-default bg-danger text-light p-2">Public Gists: ${user.public_gists}</span>
                                    <span class="label label-success bg-success text-light">Followers: ${user.followers}</span>
                                    <span class="label label-info bg-info text-light">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
