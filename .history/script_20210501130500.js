                    ...
                    $('#repo').append(`
                        <div class="well">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href=${repo.html_url} target='_blank' class="btn btn-warni">Repo Page</a>
                                </div>
                            </div>
                        </div>
                    `)
                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="label label-info bg-primary text-light p-1 px-2 my-2">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
