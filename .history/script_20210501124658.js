                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    ...
                                    <span class="col-sm-12 col-xs-12 col-md-12 label label-success bg-success text-light p-1 px-2 my-2">Followers: ${user.followers}</span>
                                    <span class="col-sm-12 col-xs-12 col-md-12 col-lg-12 label label-info bg-info text-light p-1 px-2 my-2 col">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
