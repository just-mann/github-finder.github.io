                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    <span class="col label label-default bg-dark text-light p-1 px-2 my- col">Public Repos: ${user.public_repos}</span>
                                    <span class="col label label-default bg-danger text-light p-1 px-2 my- col">Public Gists: ${user.public_gists}</span>
                                    <span class="col label label-success bg-success text-light p-1 px-2 my- col">Followers: ${user.followers}</span>
                                    <span class="col label label-info bg-info text-light p-1 px-2 my- col">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
