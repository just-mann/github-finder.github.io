                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    <span class="col label label-default bg-dark text-light p-1 px-2 my-1">Public Repos: ${user.public_repos}</span>
                                    <span class="col label label-default bg-danger text-light p-1 px-2 my-1">Public Gists: ${user.public_gists}</span>
                                    <span class="col label label-success bg-success text-light p-1 px-2 my-1">Followers: ${user.followers}</span>
