                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    ...
                                    <span class="col collabel label-default bg-danger text-light p-1 px-2 my-1">Public Gists: ${user.public_gists}</span>
                                    <span class="label label-success bg-success text-light p-1 px-2 my-1">Followers: ${user.followers}</span>
