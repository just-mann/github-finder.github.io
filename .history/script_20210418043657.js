                ...
                <div className="panel-panel-default">
                    ...
                    <div className="panel-body">
                        ...
                        <div className="col-md-9">
                            <span className="label label-default"></span><span className="label label-default"></span><span className="label label-default"></span><span className="label label-default"></span>
                        </div>
                    </div>
                </div>
            `)
