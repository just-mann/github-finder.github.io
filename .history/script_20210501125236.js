                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    <span class="col-sm-96 label label-default bg-dark text-light p-1 px-2 my-1">Public Repos: ${user.public_repos}</span>
                                    <span class="col-sm-96 label label-default bg-danger text-light p-1 px-2 my-1">Public Gists: ${user.public_gists}</span>
                                    <span class="col-sm-96 label label-success bg-success text-light p-1 px-2 my-1">Followers: ${user.followers}</span>
                                    <span class="col-sm-96 label label-info bg-info text-light p-1 px-2 my-1 col">Following: ${user.following}</span>
                                    <br/><br/>
                                    <ul class="list-group">
